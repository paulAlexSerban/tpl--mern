...
COMPOSE_FILE_DEV="../../infrastructure/docker/dev/docker-compose.blog-w-comments.dev.yml"
COMPOSE_FILE_PROD="../../infrastructure/docker/prod/docker-compose.blog-w-comments.prod.yml"
