...
COMPOSE_FILE_DEV="../../infrastructure/docker/dev/docker-compose.dummy-blog.dev.yml"
COMPOSE_FILE_PROD="../../infrastructure/docker/prod/docker-compose.dummy-blog.prod.yml"
