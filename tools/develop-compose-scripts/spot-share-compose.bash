...
COMPOSE_FILE_DEV="../../infrastructure/docker/dev/docker-compose.spot-share.dev.yml"
COMPOSE_FILE_PROD="../../infrastructure/docker/prod/docker-compose.spot-share.prod.yml"
