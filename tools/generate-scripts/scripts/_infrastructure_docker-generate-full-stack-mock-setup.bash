...
cp -r ../_templates/infrastructure_docker-full-stack-mock-compose/* ../../../infrastructure/docker/

# search and replace {{infrastructure_docker-simple-slug}} with PROJECT_NAME_SLUG
find ../../../infrastructure/docker -type f -exec sed -i '' -e "s/{{infrastructure_docker-full-stack-mock-slug}}/${PROJECT_NAME_SLUG}/g" {} \;
