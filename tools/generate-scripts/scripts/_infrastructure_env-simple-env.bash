...
# search and replace {{infrastructure_env-simple-env}} with PROJECT_NAME_SLUG
find ../../../infrastructure/env -type f -exec sed -i '' -e "s/{{infrastructure_env-simple-env}}/${PROJECT_NAME_SLUG}/g" {} \;
