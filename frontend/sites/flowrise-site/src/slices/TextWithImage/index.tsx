...
const TextWithImage = ({ slice }: TextWithImageProps): JSX.Element => {
    const classesImageContainer = clsx('rounded-lg', slice.variation === 'default' && 'md:order-2');
    return (
        <Bounded data-slice-type={slice.slice_type} data-slice-variation={slice.variation}>
            <div className="grid gap-8 md:grid-cols-2 md:place-items-center ">
                <PrismicNextImage field={slice.primary.image} className={classesImageContainer} />
